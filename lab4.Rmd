...
tidy_initial_model <- tidy(model) 

tidy_initial_model <- tidy |>
...
second <- anova(initial_model, reduced_model)
third <- anova(reduced_model, full_model)
first
