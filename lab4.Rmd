...
Most respondents self rated their enjoyment of MDS as either 3 or 4 and at a graphical level this does not appear to be associated with salary expectations post income or year. However, I note that in 2020, people who expected 100k-200k unanimously rated enjoyment as level 3.
...
*In terms of the relationship between self-rated enjoyment of MDS and salary expectation after MDS, the only significant value was between self-rated enjoyment levels 2 and 3. Which can be interpreted as:*
...
tidy_reduced_model <- tidy(full_model) 
...
*After the three goodness of fit tests, it was found that at a significance level of 0.05, the reduced model fits the data better than both the initial and full models. Therefore, I would choose the reduced model.*
