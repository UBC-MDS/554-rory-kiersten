...
*Since we have an ordinal response with increasing salary expectations, we could consider using an ordinal logistic regression model. We could use the R function*
